...
- 10 new tests in `tests/test_wormhole.py`, no regressions in the rest of the suite.
...
- 13 new tests across `tests/test_dashboard_engine.py`, `tests/test_dashboard_vector_healing.py` (new file), and `tests/test_mcp_server.py`; no regressions in `tests/test_dashboard_vqe.py` or `tests/test_wormhole.py`.
