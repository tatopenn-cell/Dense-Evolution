...
- 32 new/updated tests across `tests/test_wormhole.py`, `tests/test_simulator.py`, `tests/test_autodiff.py`, `tests/test_dashboard_engine.py`, `tests/test_dashboard_vector_healing.py` (new file), and `tests/test_mcp_server.py`; full suite passes with zero regressions.
